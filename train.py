    ...
    try:
        ...
        if args.log_to_tensorboard:
            if args.log_dir is None:
                raise ValueError("args.log_to_tensorboard set to True but args.project_name is None")
        ...
        for iteration in range(1, args.iterations + 1):
            ...
            if iteration % args.log_rate == 0:
                ...
                writer.add_image('hole_feature_point', samples, iteration, dataformats='HWC')
...
def create_argparser():
    ...
    defaults["model_save_dir"] = os.path.join(defaults["model_save_dir"], defaults["run_name"])
